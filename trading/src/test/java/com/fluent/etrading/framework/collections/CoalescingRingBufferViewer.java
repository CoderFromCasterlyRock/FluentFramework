...
public class CoalescingRingBufferViewer implements CoalescingRingBufferViewerMBean {
    private final FluentSPSCMergingQueue<?, ?> buffer;

    public CoalescingRingBufferViewer(FluentSPSCMergingQueue<?, ?> buffer) {
        this.buffer = buffer;
    }
    ...
    public static void register(String bufferName, FluentSPSCMergingQueue<?, ?> buffer, MBeanServer mBeanServer) throws JMException {
