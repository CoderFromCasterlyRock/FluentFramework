...
import com.fluent.framework.collection.MktDataDispatcher.*;
...
public final class TestDispatcherPerformance{
    ...
    public static class DummyListener2 implements MktDataListener{
        ...
        private final SpscArrayQueue<MktDataEvent> serialierQueue;
    	
        public DummyListener2( int eventCount, MyFSTSerializer serializer ){
        	this.eventCount		= eventCount;
        	this.serializer		= serializer;
        	this.serialierQueue = new SpscArrayQueue<MktDataEvent>( eventCount  );
        }
