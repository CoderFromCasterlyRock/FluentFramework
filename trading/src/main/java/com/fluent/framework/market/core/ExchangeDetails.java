...
public final class ExchangeDetails{
    ...
    public ExchangeDetails( String exchangeKey, String open, String close, String timeZoneStr, String speedLimit )
    ...
    private final void verify( String exchangeKey, String openTime, String closeTime, String timeZone, String speedimit )
            throws FluentException {

        String prefixMessage = "Exchange details is invalid as";

        if( Exchange.UNSUPPORTED == Exchange.fromCode( exchangeKey ) ){
            throw new FluentException( prefixMessage + " Exchange [" + exchangeKey + "] is invalid." );
        }

        if( isBlank( openTime ) ){
            throw new FluentException( prefixMessage + " OpenTime [" + openTime + "] is invalid." );
        }

        if( isBlank( closeTime ) ){
            throw new FluentException( prefixMessage + " CloseTime [" + closeTime + "] is invalid." );
        }
