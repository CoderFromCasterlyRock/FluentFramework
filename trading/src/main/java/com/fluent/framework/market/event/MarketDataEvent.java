...
public final class MarketDataEvent extends FluentInEvent{
    ...
    public MarketDataEvent( Exchange exchange, InstrumentSubType subType, String symbol, double bid, int bidSize,
