...
public final class StateManager implements Runnable, FluentLifecycle{
    ...
    public StateManager( FluentConfigManager config, FluentInEventDispatcher inDispatcher ){
        this( DEFAULT_DELAY, DEFAULT_UNIT, config, inDispatcher );
    }


    public StateManager( int delay, TimeUnit unit, FluentConfigManager config, FluentInEventDispatcher inDispatcher ){
